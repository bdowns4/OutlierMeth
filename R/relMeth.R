...
Beta_Map_delt_Pos= ((Beta_Map1_thr[,2:(length(Beta_Map_ID))] - (Beta_Map1_thr[,(length(Beta_Map1_thr))]))/(1-(Beta_Map1_thr[,(length(Beta_Map1_thr))])))
...
Beta_Map_delt_Neg= (((Beta_Map1_thr[,(length(Beta_Map1_thr))])-(Beta_Map1_thr[,2:(length(Beta_Map_ID))]))/((Beta_Map1_thr[,(length(Beta_Map1_thr))])))
